...
const SERVICES: readonly ServiceDef[] = [
    ...
    { id: "brake_rotor_harley_f", cat: "ブレーキ系統", name: "ブレーキローター（ハーレー・フロント）", price: 8800, bringIn: 17600, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_harley_r", cat: "ブレーキ系統", name: "ブレーキローター（ハーレー・リア）", price: 11000, bringIn: 22000, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_split_f", cat: "ブレーキ系統", name: "ブレーキローター（合わせホイール・フロント）", price: 5700, bringIn: 11400, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_split_r", cat: "ブレーキ系統", name: "ブレーキローター（合わせホイール・リア）", price: 6800, bringIn: 13600, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_split_bring", cat: "ブレーキ系統", name: "ブレーキローター（ホイール持込合わせ）", price: 4000, bringIn: 8000, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_scooter_f_125", cat: "ブレーキ系統", name: "ブレーキローター（国産スクーター～125cc・フロント）", price: 4000, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_scooter_r_125", cat: "ブレーキ系統", name: "ブレーキローター（国産スクーター～125cc・リア）", price: 5000, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_scooter_f_125_import", cat: "ブレーキ系統", name: "ブレーキローター（外車スクーター～125cc・フロント）", price: 6000, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_scooter_r_125_import", cat: "ブレーキ系統", name: "ブレーキローター（外車スクーター～125cc・リア）", price: 7500, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_big_scooter_f", cat: "ブレーキ系統", name: "ブレーキローター（国産ビッグスクーター・フロント）", price: 4400, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_big_scooter_r", cat: "ブレーキ系統", name: "ブレーキローター（国産ビッグスクーター・リア）", price: 5500, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_big_scooter_f_import", cat: "ブレーキ系統", name: "ブレーキローター（外車ビッグスクーター・フロント）", price: 6600, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_big_scooter_r_import", cat: "ブレーキ系統", name: "ブレーキローター（外車ビッグスクーター・リア）", price: 8200, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_f", cat: "ブレーキ系統", name: "ブレーキローター（国産・フロント）", price: 4400, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_r", cat: "ブレーキ系統", name: "ブレーキローター（国産・リア）", price: 5500, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_f_import", cat: "ブレーキ系統", name: "ブレーキローター（外車/社外ホイール・フロント）", price: 6600, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_r_import", cat: "ブレーキ系統", name: "ブレーキローター（外車/社外ホイール・リア）", price: 8200, notes: "タイヤ同時1700円" },
    { id: "brake_rotor_wheel_bring", cat: "ブレーキ系統", name: "ブレーキローター（ホイール持込・国産）", price: 2700, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    { id: "brake_rotor_wheel_bring_import", cat: "ブレーキ系統", name: "ブレーキローター（ホイール持込・外車）", price: 4000, notes: "ダブルディスク+1700円、タイヤ同時1700円" },
    ...
    { id: "drive_hub_damper_harley_f", cat: "駆動系統", name: "ハブダンパー（ハーレー・フロント）", price: 8800, bringIn: 17600 },
    { id: "drive_hub_damper_harley_r", cat: "駆動系統", name: "ハブダンパー（ハーレー・リア）", price: 11000, bringIn: 22000 },
    { id: "drive_hub_damper_split_f", cat: "駆動系統", name: "ハブダンパー（合わせホイール・フロント）", price: 5700, bringIn: 11400 },
    { id: "drive_hub_damper_split_r", cat: "駆動系統", name: "ハブダンパー（合わせホイール・リア）", price: 6800, bringIn: 13600 },
    { id: "drive_hub_damper_split_bring", cat: "駆動系統", name: "ハブダンパー（ホイール持込合わせ）", price: 4000, bringIn: 8000 },
    { id: "drive_hub_damper_scooter_f_125", cat: "駆動系統", name: "ハブダンパー（国産スクーター～125cc・フロント）", price: 4000 },
    { id: "drive_hub_damper_scooter_r_125", cat: "駆動系統", name: "ハブダンパー（国産スクーター～125cc・リア）", price: 5000 },
    { id: "drive_hub_damper_scooter_f_125_import", cat: "駆動系統", name: "ハブダンパー（外車スクーター～125cc・フロント）", price: 6000 },
    { id: "drive_hub_damper_scooter_r_125_import", cat: "駆動系統", name: "ハブダンパー（外車スクーター～125cc・リア）", price: 7500 },
    { id: "drive_hub_damper_big_scooter_f", cat: "駆動系統", name: "ハブダンパー（国産ビッグスクーター・フロント）", price: 4400 },
    { id: "drive_hub_damper_big_scooter_r", cat: "駆動系統", name: "ハブダンパー（国産ビッグスクーター・リア）", price: 5500 },
    { id: "drive_hub_damper_big_scooter_f_import", cat: "駆動系統", name: "ハブダンパー（外車ビッグスクーター・フロント）", price: 6600 },
    { id: "drive_hub_damper_big_scooter_r_import", cat: "駆動系統", name: "ハブダンパー（外車ビッグスクーター・リア）", price: 8200 },
    { id: "drive_hub_damper_f", cat: "駆動系統", name: "ハブダンパー（国産・フロント）", price: 4400 },
    { id: "drive_hub_damper_r", cat: "駆動系統", name: "ハブダンパー（国産・リア）", price: 5500 },
    { id: "drive_hub_damper_f_import", cat: "駆動系統", name: "ハブダンパー（外車/社外ホイール・フロント）", price: 6600 },
    { id: "drive_hub_damper_r_import", cat: "駆動系統", name: "ハブダンパー（外車/社外ホイール・リア）", price: 8200 },
    { id: "drive_hub_damper_wheel_bring", cat: "駆動系統", name: "ハブダンパー（ホイール持込・国産）", price: 2700 },
    { id: "drive_hub_damper_wheel_bring_import", cat: "駆動系統", name: "ハブダンパー（ホイール持込・外車）", price: 4000 },
