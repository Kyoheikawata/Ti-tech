...
const SERVICES: readonly ServiceDef[] = [
    ...
    { id: "tire_valve", cat: "タイヤ・ホイール系統", name: "エアバルブ単品交換", notes: "タイヤ交換と同額、部品代無料（当社指定品）" },
    ...
    { id: "tire_tube", cat: "タイヤ・ホイール系統", name: "タイヤチューブ（1本）", notes: "タイヤ交換と同額" },
    { id: "tire_tube_with", cat: "タイヤ・ホイール系統", name: "タイヤチューブ（タイヤ交換時）", notes: "タイヤ交換と同額、タイヤ交換同時0円" },
    ...
    { id: "exhaust_remove", cat: "吸排気系統", name: "マフラー脱着", notes: "交換工賃と同額、ガスケット別途、保安基準違反作業不可" },
